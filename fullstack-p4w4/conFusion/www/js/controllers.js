  ...
  $scope.addFavorite = function(index) {
    ...
    $ionicPlatform.ready(function() {
      $cordovaLocalNotification.schedule({
        id: 2,
        title: "Local Notification Added Duducheng Favorite",
      ...
      $cordovaToast.show('Toast Added Duducheng Favorite ' + $scope.dishes[index].name, 'short', 'center')
...
.controller('DishDetailController', ['$scope', '$stateParams', 'dish', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicPopover', '$ionicModal', '$ionicPlatform', '$cordovaLocalNotification', '$cordovaToast', function($scope, $stateParams, dish, menuFactory, favoriteFactory, baseURL, $ionicPopover, $ionicModal, $ionicPlatform, $cordovaLocalNotification, $cordovaToast) {
  ...
  $scope.openAddPopover = function($event) {
  ...
  $scope.addFavorite = function(index) {
    ...
    $ionicPlatform.ready(function() {
      ...
      $cordovaToast.show('Toast Added Duducheng Favorite ' + $scope.dish.name, 'short', 'bottom')
        .then(function(success) {
          console.log(success); // success
        }, function(error) {
          console.log(error); // error
  ...
  $ionicModal.fromTemplateUrl('templates/dish-comment.html', {
    ...
    $scope.commentFormModal = modal;
  });

  // Triggered in the reserve modal to close it
  $scope.closeComment = function() {
    $scope.commentFormModal.hide();
  };

  // Open the reserve modal
  $scope.showComment = function() {
    $scope.commentFormModal.show();
    $scope.addPopover.hide();
  };
...
.filter('favoriteFilter', function() { //bad implement, but just show the use of custom filter
